...
local function CreatePedAndBlip()
    for i, pedConfig in ipairs(Config.Peds) do
        ...
        if type(coords) == 'table' then
            ...
            x, y, z, heading = table.unpack(coords)
        end
        ...
        print('[UsedDealership] Spawning ped #' .. i .. ' at: ' .. tostring(x) .. ', ' .. tostring(y) .. ', ' .. tostring(z))
        ...
        print('[UsedDealership] Successfully spawned ped #' .. i)
        ...
        if pedConfig.blip and pedConfig.blip.enabled then
            ...
            spawnedBlips[i] = b
            print('[UsedDealership] Created blip for ped #' .. i)
        end
    end
end
